...
source_dir = "src"
temp_dir = "illume_temp"
export_name = "You_Can't_Save_Her_illume"
...
# Export to Illume format
os.system(f'call tweego -l -o "export/{export_name}.html" illume_temp')
os.system(
    f'call tweego -l -o "C:/Users/Sarah/Documents/GitHub/theplasmak.github.io/private/{export_name}.html" illume_temp'
)

# Check if the illume_temp directory exists and delete it
...
print("Illume export attempt complete.")
