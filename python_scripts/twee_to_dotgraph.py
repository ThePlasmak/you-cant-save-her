...
source_dir = "src"
temp_dir = "dotgraph_temp"
export_name = "You_Can't_Save_Her_dotgraph"
...
# Export to DotGraph format
os.system(f'call tweego -l -o "export/{export_name}.html" dotgraph_temp')
os.system(
    f'call tweego -l -o "C:/Users/Sarah/Documents/GitHub/theplasmak.github.io/private/{export_name}.html" dotgraph_temp'
)

# Check if the dotgraph_temp directory exists and delete it
...
print("DotGraph export attempt complete.")
