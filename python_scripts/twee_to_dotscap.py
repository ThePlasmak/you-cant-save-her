...
source_dir = "src"
temp_dir = "dotscap_temp"
export_name = "You_Can't_Save_Her_dotscap"
...
# Export to Dotscap format
os.system(f'call tweego -l -o "export/{export_name}.html" dotscap_temp')
os.system(
    f'call tweego -l -o "C:/Users/Sarah/Documents/GitHub/theplasmak.github.io/private/{export_name}.html" dotscap_temp'
)

# Check if the dotscap_temp directory exists and delete it
...
print("Dotscap export attempt complete.")
