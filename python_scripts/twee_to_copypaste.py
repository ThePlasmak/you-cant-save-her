...
source_dir = "src"
temp_dir = "copypaste_temp"
export_name = "You_Can't_Save_Her_copypaste"
...
# Export to Copypaste format
os.system(f'call tweego -l -o "export/{export_name}.html" copypaste_temp')
os.system(
    f'call tweego -l -o "C:/Users/Sarah/Documents/GitHub/theplasmak.github.io/private/{export_name}.html" copypaste_temp'
)

# Check if the copypaste_temp directory exists and delete it
...
print("Copypaste export attempt complete.")
